...
- `packages/db`: full Drizzle schema (leagues, teams, players, fixtures, fixture_events, articles, subscribers, users/accounts/sessions, comments, campaigns, campaign_entries, predictions, winners) + Neon client + drizzle.config
...
## Blocked on (keys)
- API-Football, Neon DATABASE_URL, Upstash, Resend, Cloudflare (Account ID + new token for skorly.cc)
