...
> = {
  ...
  th: {
    eyebrow: "ผู้เขียน",
    role: "บรรณาธิการฟุตบอลของ Skorly",
    bio: (name) =>
      `${name} รายงานข่าวฟุตบอลโลก 2026 พรีวิวแมตช์ บริบทตารางแข่ง และคำอธิบายการคาดการณ์ให้ Skorly`,
    focusTitle: "เนื้อหาที่เน้น",
    focus: [
      "พรีวิวแมตช์ฟุตบอลโลก 2026",
      "ข่าวทีมและบริบทตารางแข่ง",
      "คำอธิบายการคาดการณ์และหมายเหตุข้อมูล",
    ],
  },
};
