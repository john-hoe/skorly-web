...
const COPY: Record<string, MediaKitCopy> = {
  en: {
    ...
    description:
      "Reach football fans across Indonesia, Vietnam and the Philippines during World Cup 2026 — display, sponsored content and newsletter placements.",
    intro:
      "Skorly is a football news and predictions platform covering World Cup 2026 in four languages (Bahasa Indonesia, Tiếng Việt, English, 中文). We combine automated live scores, daily original news, AI-assisted match analysis and a prediction game that keeps fans coming back every match day.",
    audienceHeading: "Our audience",
    audience: [
      "Football fans in Indonesia, Vietnam and the Philippines — three of the most football-obsessed markets in Southeast Asia.",
      "Native-language coverage: every article ships in 4 languages with consistent facts.",
    ...
    products: [
      ...
      { name: "Sponsored content", desc: "Original articles or match-day features written around your brand, clearly labelled, in up to 4 languages." },
  ...
  id: {
    ...
    description:
      "Jangkau penggemar sepak bola di Indonesia, Vietnam, dan Filipina selama Piala Dunia 2026 — display, konten bersponsor, dan slot newsletter.",
    intro:
      "Skorly adalah platform berita dan prediksi sepak bola yang meliput Piala Dunia 2026 dalam empat bahasa (Bahasa Indonesia, Tiếng Việt, English, 中文). Kami menggabungkan skor langsung otomatis, berita orisinal harian, analisis pertandingan berbasis AI, dan game prediksi yang membuat fans kembali setiap hari pertandingan.",
    audienceHeading: "Audiens kami",
    audience: [
      "Penggemar sepak bola di Indonesia, Vietnam, dan Filipina — tiga pasar paling gila bola di Asia Tenggara.",
      "Liputan dalam bahasa lokal: setiap artikel terbit dalam 4 bahasa dengan fakta yang konsisten.",
    ...
    products: [
      ...
      { name: "Konten bersponsor", desc: "Artikel orisinal atau fitur hari pertandingan seputar brand kamu, berlabel jelas, hingga 4 bahasa." },
  ...
  vi: {
    ...
    description:
      "Tiếp cận người hâm mộ bóng đá tại Indonesia, Việt Nam và Philippines trong World Cup 2026 — display, bài viết tài trợ và vị trí newsletter.",
    intro:
      "Skorly là nền tảng tin tức và dự đoán bóng đá đưa tin World Cup 2026 bằng bốn ngôn ngữ (Bahasa Indonesia, Tiếng Việt, English, 中文). Chúng tôi kết hợp tỷ số trực tiếp tự động, tin tức gốc hằng ngày, phân tích trận đấu hỗ trợ bởi AI và trò chơi dự đoán giữ chân người hâm mộ mỗi ngày thi đấu.",
    audienceHeading: "Khán giả của chúng tôi",
    audience: [
      "Người hâm mộ bóng đá tại Indonesia, Việt Nam và Philippines — ba thị trường cuồng bóng đá nhất Đông Nam Á.",
      "Nội dung bằng ngôn ngữ bản địa: mỗi bài viết phát hành bằng 4 ngôn ngữ với dữ kiện nhất quán.",
    ...
    products: [
      ...
      { name: "Bài viết tài trợ", desc: "Bài viết gốc hoặc nội dung ngày thi đấu xoay quanh thương hiệu của bạn, gắn nhãn rõ ràng, tối đa 4 ngôn ngữ." },
  ...
  zh: {
    title: "在 Skorly 投放广告",
    description:
      "2026 世界杯期间触达印尼、越南、菲律宾的足球用户——展示广告、品牌内容与 Newsletter 赞助位。",
    intro:
      "Skorly 是覆盖 2026 世界杯的足球资讯与竞猜平台，以四种语言（印尼语、越南语、英语、中文）发布内容。我们提供自动化实时比分、每日原创新闻、AI 辅助赛事分析，以及让用户每个比赛日都回访的竞猜玩法。",
    audienceHeading: "我们的受众",
    audience: [
      "印尼、越南、菲律宾的足球迷——东南亚最狂热的三个足球市场。",
      "母语级内容：每篇文章以 4 种语言同步发布，事实一致。",
    ...
    products: [
      ...
      { name: "品牌内容", desc: "围绕你的品牌定制原创文章或比赛日专题，明确标注，最多 4 种语言。" },
