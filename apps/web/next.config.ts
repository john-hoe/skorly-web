...
const contentSecurityPolicy = [
  ...
  "form-action 'self'",
  "manifest-src 'self'",
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://us-assets.i.posthog.com https://challenges.cloudflare.com https://cdn.ampproject.org https://platform.twitter.com",
  "style-src 'self' 'unsafe-inline'",
  "img-src 'self' data: blob: https:",
  "font-src 'self' data:",
  "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://www.googletagmanager.com https://www.google-analytics.com https://region1.google-analytics.com https://www.google.com https://us.i.posthog.com https://challenges.cloudflare.com https://cdn.ampproject.org https://platform.twitter.com https://*.twitter.com https://*.x.com",
